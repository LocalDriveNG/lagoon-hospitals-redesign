...
const locationLinks = [
  { label: "Ikoyi", href: "https://goo.gl/maps/aFi61XJmGfxWywri7" },
  { label: "Obafemi Awolowo", href: "https://goo.gl/maps/PsWsuCjy566HK2MRA" },
  { label: "Adeniyi Jones", href: "https://goo.gl/maps/wyYBoG1WzvUzwQQR8" },
  { label: "Ligali Ayorinde", href: "https://goo.gl/maps/QLrUbjX1AhGpsn228" },
  { label: "Idejo", href: "https://goo.gl/maps/J3h6PAsciJidoAbW6" },
  { label: "Alaro City", href: "https://maps.app.goo.gl/cCxmd2p1yhoquhT76" },
];
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm font-body">
              {locationLinks.map((loc) => (
                <li key={loc.label}>
                  <a href={loc.href} target="_blank" rel="noopener noreferrer" className="text-cream/70 hover:text-gold transition-colors">{loc.label}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="mt-4">
              <a href="https://wa.me/2349139383474" target="_blank" rel="noopener noreferrer"
