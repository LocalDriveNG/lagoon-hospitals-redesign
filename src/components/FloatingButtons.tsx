...
const FloatingButtons = () => {
  return (
    <>
      ...
      {/* Emergency - bottom left */}
      <a
        href="tel:+2347086393027"
        className="fixed bottom-6 left-6 z-50 w-14 h-14 rounded-full bg-destructive flex items-center justify-center shadow-lg hover:scale-110 transition-transform"
